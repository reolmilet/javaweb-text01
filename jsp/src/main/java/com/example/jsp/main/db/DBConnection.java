package com.example.jsp.main.db;
...
public class DBConnection {
	...
	private static final String URL = "jdbc:mysql://localhost:3306/javaweb01?useUnicode=yes&allowPublicKeyRetrieval=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=UTC";
